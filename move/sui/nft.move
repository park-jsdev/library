...
module overmind::NonFungibleToken {
    ...
    */
    fun init(ctx: &mut TxContext) {
        ...
        // Create a new MinterCap object with a unique ID and the initial sales balance and
        // Transfer ownership of the MinterCap to the transaction sender (module deployer)
    ...
    */
    public fun mint_nft(
        ...
        let change = 1 - coin::value(payment_coin);
        ...
        transfer::transfer(nft, recipient); // transfer the nft to sender
        pay::split_and_transfer(payment_coin, change, recipient, ctx) ; // this returns the change to the minter cap's balance
        change
    }
    ...
    */
    public fun combine_nfts(
        ...
        let new_name = string::utf8(b"");
        string::append(&mut new_name, nft1.name);
        ...
        // Emit event for newly minted NFT 
        ...
        // Emit event for deleting the 1st NFT
    ...
    */
    public fun withdraw_sales(
        ...
        let withdrawal_amount = balance::value(&mut minter_cap.sales);
        let withdrawn_coin = coin::take(&mut minter_cap.sales, withdrawal_amount, ctx);
