...
// Space: O(n + m) = O(n)
/**
    Remember the multiplication algorithm and translate to code.

    It is easiest to work with an array, and convert back to string at the end.
 */

class Solution {
    public String multiply(String num1, String num2) {
        
        // Basic check, if any num is 0, return 0
        ...
        // Get the proper starting point to avoid leading zeroes
        int startIndex = 0;
