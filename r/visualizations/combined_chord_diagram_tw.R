...
stacked_bar_disease <- ggplot(df_for_chord, aes(x = DiseaseModel, y = Count, fill = TaskArea)) +
  ...
  theme(
    ...
    axis.title = element_text(size = 22, margin = margin(t = 10, r = 0, b = 10, l = 0)),  # Increase axis title size and margin
...
bar_plot_disease_image <- readPNG("stacked_bar_plot_disease_model_tw.png")
bar_plot_task_image <- readPNG("stacked_bar_plot_task_area_tw.png")
