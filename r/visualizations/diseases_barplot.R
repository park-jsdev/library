...
bar_plot_diseases <- ggplot(counts_diseases, aes(x = reorder(wrap_labels(`Disease Model`), -n), y = n, fill = `Disease Model`)) +
  geom_bar(stat = "identity", color = "black", size = 1, width = 0.8) +  # Increase bar width and reduce border thickness
  ...
  theme(
    ...
    axis.text.x = element_text(angle = 45, hjust = 1, size = 24, face = "bold", color = "black"),  # Increase axis text size and angle
    axis.text.y = element_text(size = 24, face = "bold", color = "black"),  # Increase axis text size
    axis.title.x = element_text(size = 28, face = "bold", color = "black", margin = margin(t = 20, r = 20, b = 50, l = 20)),  # Increase axis title size and margin
    axis.title.y = element_text(size = 28, face = "bold", color = "black", margin = margin(t = 20, r = 20, b = 20, l = 20)),  # Increase axis title size and margin
